...
use App\Http\Controllers\api\v1\TagItemController;
use App\Http\Controllers\api\v1\OutOfServiceController;
...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::group(['prefix' => 'tag', 'middleware' => ['role:user']], function () {
            ...
            Route::post('tag_item/{id}/create', [TagItemController::class, 'store']);
            Route::get('tag_item/{id}', [TagItemController::class, 'show']);
        });
        ...
        Route::group(['prefix' => 'store_members', 'middleware' => ['role:user']], function () {
            Route::post('/{id}/follow', [StoreMemberController::class, 'store']);
            Route::get('/{id}/store', [StoreMemberController::class, 'show']);
            Route::patch('/{id}/approve', [StoreMemberController::class, 'update']);
        });
        ...
        Route::group(['prefix' => 'out_of_service', 'middleware' => ['role:user']], function () {
            Route::post('/create', [OutOfServiceController::class, 'store']);
            Route::get('/{id}', [OutOfServiceController::class, 'show']);
        });
    });
});
